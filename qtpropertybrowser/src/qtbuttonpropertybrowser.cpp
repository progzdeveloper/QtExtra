...
void QtButtonPropertyBrowserPrivate::setVisible(WidgetItem *item, bool visible)
{
...
/*!
    Sets the \a item to either visible or invisible, depending on the value of \a visible.
