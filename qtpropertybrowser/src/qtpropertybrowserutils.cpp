    ...
    m_textVisible(true)
{
    ...
    m_checkBox->setText(tr(qtBoolAlpha[1]));
}
...
void QtBoolEdit::setTextVisible(bool textVisible)
{
    ...
    if (m_textVisible)
        m_checkBox->setText(tr(qtBoolAlpha[(int)isChecked()]));
    else
